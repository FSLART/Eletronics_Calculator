...
def create_eletronics_tab(notebook):
    ...
    tk.Button(frame_eletronics, text="Capacitor Energy", **button_options, command=create_cap_energy_window).grid(row=1, column=0, sticky="nsew", padx=5, pady=5)
    tk.Button(frame_eletronics, text="Capacitor Charge/Discharge", **button_options, command=create_cap_charge_discharge_window).grid(row=1, column=1, sticky="nsew", padx=5, pady=5)
    tk.Button(frame_eletronics, text="Capacitor Calculator", **button_options, command=create_capacitor_window).grid(row=1, column=2, sticky="nsew", padx=5, pady=5)
    tk.Button(frame_eletronics, text="Inductor Charge/Discharge", **button_options, command= create_ind_charge_discharge_window).grid(row=2, column=0, sticky="nsew", padx=5, pady=5)
    tk.Button(frame_eletronics, text="Inductor Calculator", **button_options, command=create_inductor_window).grid(row=2, column=1, sticky="nsew", padx=5, pady=5)
    tk.Button(frame_eletronics, text="Ohm's Law", **button_options, command= create_ohms_window).grid(row=3, column=0, sticky="nsew", padx=5, pady=5)
    tk.Button(frame_eletronics, text="Power Calculator", **button_options, command= create_power_window).grid(row=3, column=1, sticky="nsew", padx=5, pady=5)
    tk.Button(frame_eletronics, text="Phase Angle Calculator", **button_options, command=create_phase_angle_window).grid(row=3, column=2, sticky="nsew", padx=5, pady=5)
