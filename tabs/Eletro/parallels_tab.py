...
def parse_complex(value):
    ...
    try:
        if "i" in value:
            value = value.replace(
                "i", "j"
            )  # Replace 'i' with 'j' for Python compatibility
        return complex(value)
    except ValueError:
        raise ValueError(
            "Invalid complex number format. Please use 'a + bi' or 'a + bj', where 'a' and 'b' are numbers."
        )


def calculate_1_resistors(
    entry_resistor1,
    entry_resistor2,
    entry_resistor3,
    entry_resistor4,
    ...
    if len(resistors) < 2:
        messagebox.showerror(
            "Input Error",
            "Please enter at least two valid resistor values greater than zero.",
        )
        return
...
def calculate_2_inductors(
    ...
    try:
        ...
        messagebox.showerror(
            "Input Error", "Please enter a valid frequency greater than zero."
        )
        return
    ...
    if len(inductors) < 2:
        messagebox.showerror(
            "Input Error",
            "Please enter at least two valid inductive values greater than zero.",
        )
        return
...
def calculate_3_capacitor(
    ...
    if len(capacitors) < 2:
        messagebox.showerror(
            "Input Error",
            "Please enter at least two valid capacitive values greater than zero.",
        )
        return
...
def create_parallels_window():
    ...
    tk.Label(frame_Equivalent_Resistence, text="Resistor 6 (Ω):").grid(
    ...
    label_result1 = tk.Label(
        frame_Equivalent_Resistence, text="Result will appear here."
    )
    label_result1.grid(row=7, column=0, columnspan=2, pady=10)

    # Bobines

    tk.Label(frame_Equivalent_Resistence, text="Inductor 1 (H):").grid(
        row=0, column=2, padx=10, pady=5
    )
    entry_inductor1 = tk.Entry(frame_Equivalent_Resistence)
    entry_inductor1.grid(row=0, column=3, padx=10, pady=5)

    tk.Label(frame_Equivalent_Resistence, text="Inductor 2 (H):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Inductor 3 (H):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Inductor 4 (H):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Inductor 5 (H):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Inductor 6 (H):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Frequency (Hz):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Capacitor 1 (F):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Capacitor 2 (F):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Capacitor 3 (F):").grid(
    ...
    tk.Label(frame_Equivalent_Resistence, text="Capacitor 4 (F):").grid(
